...
public class AdminBookController {
    ...
    @Autowired
    private BookImageRepository bookImgRepository;
...
//        }
        ...
        Author at= AuthRepository.getAllAuthor();
        Publisher pb=pubRepository.getAllPublisher();
        book.setAuthor(at);
        book.setPublisher(pb);
        bookRepository.save(book);
        BookImage bi=new BookImage();
        Image im=ImgRepository.getAllImage();
        bi.setBook(book);
        bi.setImage(im);
        bookImgRepository.save(bi);
